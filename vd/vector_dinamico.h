...
vector_t* vector_crear(size_t tam); //ok
...
// a nuevo_tam
bool vector_redimensionar(vector_t* vector, size_t nuevo_tam); //ok
...
bool vector_obtener(vector_t* vector, size_t pos, int* valor);//ok
...
bool vector_guardar(vector_t* vector, size_t pos, int valor); //ok

// Devuelve el tamaño del vector
// Pre: el vector fue creado
size_t vector_obtener_tamanio(vector_t* vector); //ok
